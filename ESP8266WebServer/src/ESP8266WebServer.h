...
public:
  ...
  void collectCookies(const char* cookieKeys[], const size_t cookieKeysCount); // set the request cookies to collect
...
protected:
  ...
  void _parseCookies(String cook);
  ...
  int              _cookieKeysCount;
  RequestArgument* _currentCookies;
